...
def index():
    if request.method == 'POST':
                try:
                    ...
                    save_directory = "img_scrapper/images"
                    ...
                    for index,image_tag in enumerate(image_tags):
                                ...
                                with open(os.path.join(save_directory, f"{query}_{image_tags.index(image_tag)}.jpg"), "wb") as f:
                                    f.write(image_data)
                    client = pymongo.MongoClient("mongodb+srv://gauravshukla:Gaurav@8181@cluster0.k6lcosc.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
